...
class MlClient(NamespacedClient):
    ...
    def close_job(
        ...
        *,
        ...
        """
        Closes one or mor        if filter_id in SKIP_IN_PATH:
        ...
        )A job can be opened and closed multiple
        times throughout its lifecycle.

        `<https://www.elastic.co/guide/en/elasticsearch/reference/master/ml-close-job.html>`_

        :param job_id: Identifier for the anomaly detection job.         if filter_id in SKIP_IN_PATH:
            raise ValueError("Empty value passed for parameter 'filter_id'")
