...
class MlClient(NamespacedClient):
    ...
    async def close_job(
        ...
        *,
        ...
        """
        Closes one or more             if items is not None:
                __body["items"] = items
        __headers = {"accept": "application/json", "content-type": "application/json"}maly detection jobs. A job can be opened and closed multiple
