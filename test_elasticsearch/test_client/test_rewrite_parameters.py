...
class TestRewriteParameters:
    ...
    @_rewrite_parameters(body_name="document", body_required=False)
    ...
    @_rewrite_parameters(
        body_fields=True, ignore_deprecated_options={"api_key", "body", "params"}, body_required=False
    )
    ...
    def test_body_required_false(self):
        # Test that body is optional when body_required=False
